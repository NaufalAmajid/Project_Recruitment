                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="javascript:;" onclick="detailLoker('<?= $loker['id_loker'] ?>')" class="text-primary bg-light-primary"><i class="bx bxs-edit"></i></a>
